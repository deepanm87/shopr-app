...
export default function Header() {
  ...
  return (
    <header className="flex flex-wrap justify-between items-center px-4 py-2">
        <div className="flex w-full flex-wrap justify-betwen items-center">
          <Link 
            href="/"
            ...
            <ClerkLoaded>
              ...
              { user?.passkeys.length === 0 && (
                <button
                  ...
                  className="bg-white hover:bg-blue-700 hover:text-white animate-pulse text-blue-500
                   font-bold py-2 px-4 rounded border-blue-300 border"
                >
                  Create passkey
                </button>
              )}
